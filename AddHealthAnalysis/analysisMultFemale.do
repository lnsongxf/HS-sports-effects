...
log using "analysisMultFemale.log", replace
...
qui listtex holderName holderAthlete0 holderAthlete1 holderOverall in 1/`=`i'' using sumStatsTableMultFemale.tex, replace delimiter(" & ") end ("   \tabularnewline")
