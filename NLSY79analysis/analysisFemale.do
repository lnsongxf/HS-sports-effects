...
log using "analysisFemale.log", replace
...
mdesc athlete hgc gradHS grad4yr lnfamInc78 m_famInc1978 exper commOrg hobbyClub studentCouncil yrbookPaper performArts nhs otherClub no_clubs hgc*th m_hgc*th *asvab?? rotter_score if age==25
...
preserve
    ...
    *-----------------------------------------
    ...
    foreach var in `allvars' {
        ...
        if "`test'"=="1" {
            ...
            qui ttest `var' if age==25, by(athlete)
            qui replace holderOverallPflag = (`r(p)'<.05) if _n==`i'
            foreach a in 0 1 {
                qui sum `var' if age==25 & athlete==`a', d
                local temp: di %3.2f `r(mean)'
    ...
    * Add asterisk if athletes are significantly different from non-athletes
    ...
    qui listtex holderName holderAthlete0 holderAthlete1 holderOverall in 1/`=`i'' using sumStatsTableAthleteFemale.tex, replace delimiter(" & ") end ("   \tabularnewline")

    drop *_100
restore

sum voter if year==2012 & female & athlete==1
sum voter if year==2012 & female & athlete==0
    ...
    foreach depvar in `depvars' {
        ...
        if "`depvar'"=="lnwage" | "`depvar'"=="empPT" | "`depvar'"=="empFT"  {
            foreach a in 25 30 35 {
                ...
                di "         "
                di "********************"
                regress   `depvar' athlete               if age==`a'
                est sto simple
                regress   `depvar' athlete `labmktvs`a'' if age==`a'
                est sto ols
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts0'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts1'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts2'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts3'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts4'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts5'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts6'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts7'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts8'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts9'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts10'
                `arCeeAr' `depvar' athlete `labmktvs`a'' if age==`a' `arCeeArOpts11'
                est table simple ols, b(%9.3f) stats(N) keep(athlete) title("Table: effects of athlete on `depvar' at age `a'")
            }
        }
            ...
            foreach a in 25 30 35 {
                ...
                regress   `depvar' athlete               if age==`a'
                est sto simple
                regress   `depvar' athlete `basevars`a''    if age==`a'
                est sto ols
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts0'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts1'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts2'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts3'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts4'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts5'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts6'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts7'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts8'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts9'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts10'
                `arCeeAr' `depvar' athlete `basevars`a''    if age==`a' `arCeeArOpts11'
                est table simple ols, b(%9.3f) stats(N) keep(athlete) title("Table: effects of athlete on `depvar' at age `a'")
            }
        }
        else {
            regress   `depvar' athlete                if age==25
            est sto simple
            regress   `depvar' athlete `basevars'     if age==25
            est sto ols
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts0'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts1'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts2'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts3'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts4'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts5'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts6'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts7'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts8'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts9'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts10'
            `arCeeAr' `depvar' athlete `basevars'     if age==25 `arCeeArOpts11'
            est table simple ols, b(%9.3f) stats(N) keep(athlete) title("Table: effects of athlete on `depvar'")
        }
        di "      "
        di "      "
        di "      "
        ...
        di "      "
            ...
            regress   voter athlete                if year==2012
            est sto simple
            regress   voter athlete `basevars'     if year==2012
            est sto ols
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts0'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts1'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts2'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts3'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts4'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts5'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts6'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts7'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts8'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts9'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts10'
            `arCeeAr' voter athlete `basevars'     if year==2012 `arCeeArOpts11'
            est table simple ols, b(%9.3f) stats(N) keep(athlete) title("Table: effects of athlete on voter")
restore
