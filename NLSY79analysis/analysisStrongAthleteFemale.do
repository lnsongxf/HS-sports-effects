...
log using "analysisStrongAthleteFemale.log", replace
...
preserve
    ...
    * Add asterisk if athletes are significantly different from non-athletes
    ...
    qui listtex holderName holderAthlete0 holderAthlete1 holderOverall in 1/`=`i'' using sumStatsTableStrongAthleteFemale.tex, replace delimiter(" & ") end ("   \tabularnewline")
